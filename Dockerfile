...
RUN cd /var/www/html && \
    wget -O download.tar.gz https://get.typo3.org/11.5.12 && \
    echo "5c7ca60b205a719f95ec3316a7fe7850413187be31494aaa23df9a8a31fcc423 download.tar.gz" > download.tar.gz.sum && \
