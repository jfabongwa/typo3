...
return [
    ...
    'types' => [
        '1' => ['showitem' => 'title, content, postdate, comments, author, tags, --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:access, hidden, starttime, endtime'],
    ],
    'columns' => [
        'hidden' => [
            'exclude' => true,
