...
class Standard_action_index_28563707bd13708ebcf0b801b541282600a061a0 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output12 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('iteration.cycle', $array14)]);

$output12 .= '" class="nav-link ';
// Rendering ViewHelper TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper
...
$array17 = array();
$array18 = array (
);$array17['0'] = $renderingContext->getVariableProvider()->getByPath('iteration.cycle', $array18);
$array17['1'] = ' == ';
$array19 = array (
);$array17['2'] = $renderingContext->getVariableProvider()->getByPath('defaultTabIndex', $array19);
...
$output12 .= '" role="tab" data-bs-toggle="tab">
                        ';
// Rendering ViewHelper TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper
